...
?>
    ...
    <div id="payment" class="backgroundColor" style="">
        ...
        <div class="bottomDiv">
			...
			<form action="PaymentPage.php" method='post' name='sendform' onSubmit='pay()'>	
                <input id="btnPay" type="submit" class="topUpButton" value="Top Up">
				<!--onclick="pay()" />-->
			</form>
    ...
    <script>
            ...
            payment: function(data, actions) {
                ...
                return actions.payment.create({
                    payment: {
                        transactions: [
                            {
                                amount: { total: sessionStorage["value"], currency: sessionStorage["currency"] }
                            }
                        ]
                    }
                });
		...
		console.log(sessionStorage['countrycode']);
